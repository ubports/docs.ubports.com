...
.. note::
    ...
    We highly suggest that you follow the :doc:`Halium porting guide <../porting/introduction/index>` if you want to bring up a new device. The steps in here are only relevant for hammerhead, bacon and FP2.
